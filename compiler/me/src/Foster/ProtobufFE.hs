...
cb_parseSourceModuleWithLines standalone lines sourceFile cbor = case cbor of
 ...
 where
  ...
  markFnAsProc (FnTypeP d r cc _) = (FnTypeP d r cc FT_Proc)
  ...
  cb_parse_tatom cbor = case cbor of
    ...
    CBOR_Array [tok, _,_cbr, CBOR_Array [tuple, _mu]]          | tok `tm` tok_FUNC_TYPE ->
        let tys = map cb_parse_t (unTuple tuple) in
        FnTypeP (init tys) (last tys) FastCC FT_Func
    CBOR_Array [tok, _,_cbr, CBOR_Array [tuple, _mu, tannots]] | tok `tm` tok_FUNC_TYPE ->
        let annots = cb_parse_tannots tannots in
        let (cc, ft) = extractFnInfoFromAnnots annots in
        let tys = map cb_parse_t (unTuple tuple) in
        FnTypeP (init tys) (last tys) cc ft
...
--------------------------------------------------------------------------------
-- Autogenerated
_tok_TICK_STR_CONTENTS = 104
_tok_UNDER_IDENT = 79
_tok_SYMBOL_CONTINUE_NDIG = 93
_tok_WORD_CHAR = 88
_tok_DO = 6
_tok_TYPE = 25
_tok_TICK_STR = 100
_tok_SMALL_IDENT = 77
_tok_INT_RAT_BASE = 84
_tok_EQ = 23
_tok_DQUO_STR = 75
_tok_LINE_COMMENT = 108
_tok_SYMBOL_SINGLE_START = 91
_tok_IDENT_SYMBOL = 90
_tok_TYPE_TYP_ABS = 58
_tok_UNICODE_INNER = 107
_tok_IDENT_CONTINUE = 89
_tok_WS = 111
_tok_OR = 22
_tok_TDQU_STR = 101
_tok_BACKSLASH = 99
_tok_WHERE = 12
_tok_SYMBOL_CONTINUE = 94
_tok_END = 19
_tok_UPPER_IDENT = 78
_tok_AND = 21
_tok_TYPE_CTOR = 65
...
_tok_DQUO = 97
_tok_KIND_TYOP = 60
_tok_IDENT_START_UPPER = 87
_tok_TICK = 95
_tok_TYP_ABS = 54
_tok_TRTK_STR = 102
_tok_TO = 10
_tok_HEX_DIGIT = 85
_tok_SCI_NOTATION = 83
_tok_ASSIGN_TO = 51
_tok_MINUS = 24
_tok_NUM = 80
_tok_HEX_CLUMP = 82
_tok_FORMALS = 28
_tok_DQUO_STR_CONTENTS = 105
_tok_NESTING_COMMENT = 109
_tok_LET = 11
...
_tokNameOf id =
  case id of
    104 -> "TICK_STR_CONTENTS"
    79 -> "UNDER_IDENT"
    93 -> "SYMBOL_CONTINUE_NDIG"
    88 -> "WORD_CHAR"
    31 -> "LETS"
    18 -> "CASE"
    34 -> "STMTS"
