                        ...
                        llvm::Type* argTypes)
{
  ...
  Value* fcoro_slot = this->emitMalloc(getSplitCoroType(argTypes), bogusCtor, /*init*/ true);
  Value* ccoro_slot = this->emitMalloc(getSplitCoroType(retTy   ), bogusCtor, /*init*/ false);
