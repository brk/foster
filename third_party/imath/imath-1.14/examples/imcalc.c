/*
  ...
  Info:     $Id: imcalc.c 635 2008-01-08 18:19:40Z sting $

  This is a very simplistic RPN calculator that will let you test the
  features of the IMath built-in functions.
 */
...
/* A cstate_t represent a stack of operands; numeric operands are
   pushed on the stack, and commands cause them to be consumed in
   various ways.
 */
typedef struct {
  /* Operand stack    */
